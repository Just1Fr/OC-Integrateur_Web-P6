...
const IMG_PLACEHOLDER_SVG = 
    `<svg class="img-placeholder hideOnPreview" width="76" height="76" viewBox="0 0 76 76" xmlns="http://www.w3.org/2000/svg">
...
async function uploadWork(title, categoryId, image) {
    const token = localStorage.getItem("token");
    if (token) {
    ...
    formContainer.innerHTML = 
        `<form id="add-picture-form">
            <div class="preview-container">
                ${IMG_PLACEHOLDER_SVG}
                <img id="new-work-preview" src="" alt="New work preview" style="display:none">
                <label class="hideOnPreview" for="new-work-img">+ Ajouter photo</label>
                <input class="hideOnPreview" id="new-work-img" name="new-work-img" type="file" accept=".png, .jpg, .jpeg">
                <span class="hint hideOnPreview">jpg, png : 4mo max</span>
            </div>
            <div class="input">
                <label for="new-work-title">Titre</label>
                <input id="new-work-title" name="new-work-title" type="text">
            </div>
            <div class="input">
                <label for="new-work-category">Catégorie</label>
                <select id="new-work-category" name="new-work-category"></select>
            </div>
        </form>`;
